...
DeviceProcessEvents
| where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-(version).exe  /S"
...
## Created By:
- **Author Name**: Benjamin Cole
- **Author Contact**: https://www.linkedin.com/in/thebenjamincole/
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `January 14, 2026`  | `Benjamin Cole`   
